  ...
  return (
    <div style={{ maxWidth: 380 }}>
      <div style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
        ...
        <button
          onClick={addTask}
          style={{ padding: '8px 16px', background: '#770081', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer' }}
        >
          Agregar
        </button>
      </div>
        ...
        {tasks.map((task) => (
          ...
          >
            ...
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'rgb(109, 0, 0)', fontSize: 16 }}
            >
              ✕
            </button>
          </li>
